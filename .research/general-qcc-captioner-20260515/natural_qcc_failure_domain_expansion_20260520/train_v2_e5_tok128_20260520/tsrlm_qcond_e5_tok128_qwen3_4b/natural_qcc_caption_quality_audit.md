...
- evidence shape rate: `0.6857`
- numeric evidence rate: `0.6857`
- answer-label-only rate: `0.2000`
...
| `grid2op` | 10 | 0.4000 | 0.4000 | 0.4000 |
| `traffic` | 12 | 0.8333 | 0.1667 | 0.8333 |
| `water` | 6 | 0.5000 | 0.1667 | 0.5000 |

## Failure Reasons

`{'answer_label_only': 7, 'no_numeric_evidence': 11, 'too_short': 7}`
