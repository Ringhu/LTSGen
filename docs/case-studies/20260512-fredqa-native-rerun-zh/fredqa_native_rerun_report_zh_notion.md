...
## 📈 Case 01: FREDQA `832` | OpenTSLM 原生多变量救回 fixed 逐变量失败
...
## 📈 Case 02: FREDQA `392` | OpenTSLM 原生多变量不如 fixed 逐变量
...
## 📈 Case 03: FREDQA `111` | ChatTS 原生多变量对，OpenTSLM 原生多变量错
...
## 📈 Case 04: FREDQA `210` | OpenTSLM 原生多变量对，ChatTS 原生多变量错
...
## 📈 Case 05: FREDQA `481` | 两个原生多变量 caption 都错，但 numbers 对
...
## 📈 Case 06: FREDQA `701` | 三种 caption 都错，但 numbers 对
...
## 📈 Case 07: FREDQA `115` | meta-only 错，但 OpenTSLM 原生多变量 caption 对
...
## 📈 Case 08: FREDQA `396` | meta-only 错，但 ChatTS 原生多变量 caption 对
...
## 📈 Case 09: FREDQA `587` | caption-only 对，但 caption+numbers 反而错
...
## 📈 Case 10: FREDQA `6` | meta、numbers、三种 caption 全错
