...
> Notion 版说明：本文件由 GitHub 主报告自动派生，去掉 HTML 折叠标签，并把图片链接改为 GitHub raw URL。GitHub 主报告保留折叠 case study 结构。

- GitHub 主报告：https://github.com/Ringhu/LTSGen/blob/fredqa-rerun-zh-20260512/docs/case-studies/20260512-integrated-analysis-zh/integrated_case_study_statistics_report_zh.md
- GitHub Notion 源文件：https://github.com/Ringhu/LTSGen/blob/fredqa-rerun-zh-20260512/docs/case-studies/20260512-integrated-analysis-zh/integrated_case_study_statistics_report_zh_notion.md
...
| L3 机制拆解 | [Caption factuality slot table](https://github.com/Ringhu/LTSGen/blob/fredqa-rerun-zh-20260512/docs/case-studies/20260512-integrated-analysis-zh/tables/caption_factuality_full_per_slot.csv) | caption 中每个事实槽位和 numpy GT 是否一致 | 把“caption 幻觉/信息损失”从定性判断推进到 slot-level factuality |
| L4 任务结构拆解 | [Multivariate/domain condition tables](https://github.com/Ringhu/LTSGen/blob/fredqa-rerun-zh-20260512/docs/case-studies/20260512-integrated-analysis-zh/tables/overall_condition_deltas.csv) | benchmark 里到底有多少多变量题、真领域题，以及这些子集上各条件表现如何 | 区分“领域外壳”和“真实领域知识”，并量化多变量负载 |
...
![Caption factuality hit-rate heatmap](https://raw.githubusercontent.com/Ringhu/LTSGen/fredqa-rerun-zh-20260512/docs/case-studies/20260512-integrated-analysis-zh/figures/caption_factuality_hit_rate_heatmap.png)

![Caption factuality miss-type distribution](https://raw.githubusercontent.com/Ringhu/LTSGen/fredqa-rerun-zh-20260512/docs/case-studies/20260512-integrated-analysis-zh/figures/caption_factuality_miss_type_distribution.png)
