...
- slot value recall: `0.0000`
- direction pass rate: `0.2857`
- horizon pass rate: `0.0000`

## By Source

| source | n | overall | value pass | value recall | direction | horizon | failures |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `aiopslab_official_v3` | 5 | 0.4000 | 0.4000 | 0.0000 | 0.0000 | 0.0000 | `{'slot_value_mismatch': 3}` |
| `citylearn` | 2 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | `{'slot_value_mismatch': 2, 'direction_mismatch': 1, 'horizon_mismatch': 1}` |
| `grid2op` | 10 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | `{'slot_value_mismatch': 10, 'direction_mismatch': 3, 'horizon_mismatch': 3}` |
| `traffic` | 12 | 0.0833 | 0.0833 | 0.0000 | 0.5000 | 0.0000 | `{'slot_value_mismatch': 11, 'horizon_mismatch': 2, 'direction_mismatch': 1}` |
| `water` | 6 | 0.0000 | 0.0000 | 0.0000 | 1.0000 | 0.0000 | `{'slot_value_mismatch': 6, 'horizon_mismatch': 1}` |

## Main Failure Reasons

`{'slot_value_mismatch': 32, 'direction_mismatch': 5, 'horizon_mismatch': 7}`
