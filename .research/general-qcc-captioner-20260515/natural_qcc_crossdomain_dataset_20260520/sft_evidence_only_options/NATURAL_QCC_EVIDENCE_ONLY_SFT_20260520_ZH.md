...
- output dir: `.research/general-qcc-captioner-20260515/natural_qcc_crossdomain_dataset_20260520/sft_evidence_only_options`
- include options in qcond prompt: `True`
...
| --- | ---: | ---: | --- | --- |
| `no_question` | 42 | 13 | `.research/general-qcc-captioner-20260515/natural_qcc_crossdomain_dataset_20260520/sft_evidence_only_options/natural_qcc_crossdomain_evidence_only_options_no_question_train_sft.jsonl` | `.research/general-qcc-captioner-20260515/natural_qcc_crossdomain_dataset_20260520/sft_evidence_only_options/natural_qcc_crossdomain_evidence_only_options_no_question_test_sft.jsonl` |
| `qcond` | 42 | 13 | `.research/general-qcc-captioner-20260515/natural_qcc_crossdomain_dataset_20260520/sft_evidence_only_options/natural_qcc_crossdomain_evidence_only_options_train_sft.jsonl` | `.research/general-qcc-captioner-20260515/natural_qcc_crossdomain_dataset_20260520/sft_evidence_only_options/natural_qcc_crossdomain_evidence_only_options_test_sft.jsonl` |
