...
- predictions: `.research/general-qcc-captioner-20260515/natural_qcc_crossdomain_dataset_20260520/local_caption_ranker/no_question/predictions.jsonl`
...
- evidence shape rate: `0.0000`
- numeric evidence rate: `0.0000`
- answer-label-only rate: `1.0000`

## By Source

| source | n | evidence shaped | answer-label-only | numeric evidence |
| --- | ---: | ---: | ---: | ---: |
| `aiopslab_official_v3` | 5 | 0.0000 | 1.0000 | 0.0000 |
| `citylearn` | 2 | 0.0000 | 1.0000 | 0.0000 |
| `grid2op` | 2 | 0.0000 | 1.0000 | 0.0000 |
| `traffic` | 3 | 0.0000 | 1.0000 | 0.0000 |
| `water` | 1 | 0.0000 | 1.0000 | 0.0000 |

## Failure Reasons

`{'answer_label_only': 13, 'no_numeric_evidence': 13}`
