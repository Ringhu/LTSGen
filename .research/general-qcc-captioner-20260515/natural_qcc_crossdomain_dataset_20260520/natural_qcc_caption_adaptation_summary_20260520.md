...
| --- | --- | ---: | ---: | ---: | ---: |
| `natural_oracle` | `oracle_evidence` | 1.0000 | 0.9091 | 0.0000 | `True` |
| `natural_evidence_no_label` | `oracle_evidence_without_answer_label` | 0.6545 | 0.9091 | 0.0000 | `True` |
| `nearest_caption_question_conditioned` | `train_split_nearest_caption_probe` | 0.4615 | 0.7692 | 0.0000 | `False` |
| `nearest_caption_no_question` | `train_split_nearest_caption_probe` | 0.2308 | 0.9231 | 0.0000 | `True` |
| `local_ranker_qcond` | `local_option_ranker_answer_label_shortcut` | 0.6154 | 0.0000 | 1.0000 | `False` |
| `local_ranker_no_question` | `local_option_ranker_answer_label_shortcut` | 0.6154 | 0.0000 | 1.0000 | `False` |
