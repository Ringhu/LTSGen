...
- predictions: `.research/general-qcc-captioner-20260515/natural_qcc_seed_smoke_3090_20260521/train_seed72_step6_tok768/qcond_seed72/generate_eval18_clean/predictions.jsonl`
...
- evidence shape rate: `0.8889`
- numeric evidence rate: `0.8889`
...
| --- | ---: | ---: | ---: | ---: |
| `aiopslab` | 3 | 1.0000 | 0.0000 | 1.0000 |
| `citylearn` | 3 | 1.0000 | 0.0000 | 1.0000 |
| `finrl` | 3 | 0.3333 | 0.0000 | 0.3333 |
| `grid2op` | 3 | 1.0000 | 0.0000 | 1.0000 |
| `traffic` | 3 | 1.0000 | 0.0000 | 1.0000 |
| `water` | 3 | 1.0000 | 0.0000 | 1.0000 |

## Failure Reasons

`{'no_numeric_evidence': 2}`
