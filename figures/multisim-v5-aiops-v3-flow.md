# MultiSim v5 AIOps v3 Flow

This diagram shows the expanded simulator data path, the model smoke training path, and the bounded evaluation path for the 2026-05-18 MultiSim v5 AIOpsLab v3 run.
