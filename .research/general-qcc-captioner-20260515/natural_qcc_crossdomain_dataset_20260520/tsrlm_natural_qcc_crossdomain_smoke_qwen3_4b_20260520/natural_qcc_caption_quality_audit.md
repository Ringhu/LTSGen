...
- evidence shape rate: `0.3846`
- numeric evidence rate: `0.3846`
- answer-label-only rate: `0.5385`

## By Source

| source | n | evidence shaped | answer-label-only | numeric evidence |
| --- | ---: | ---: | ---: | ---: |
| `aiopslab_official_v3` | 5 | 0.4000 | 0.6000 | 0.4000 |
| `citylearn` | 2 | 0.0000 | 1.0000 | 0.0000 |
| `grid2op` | 2 | 0.0000 | 0.5000 | 0.0000 |
| `traffic` | 3 | 1.0000 | 0.0000 | 1.0000 |
| `water` | 1 | 0.0000 | 1.0000 | 0.0000 |

## Failure Reasons

`{'answer_label_only': 7, 'no_numeric_evidence': 8, 'too_short': 7, 'option_letter_leak': 2}`
