...
- predictions: `.research/general-qcc-captioner-20260515/natural_qcc_crossdomain_dataset_20260520/tsrlm_natural_qcc_crossdomain_no_question_smoke_qwen3_4b_20260520/generate_eval_test_clean/predictions.jsonl`
...
- evidence shape rate: `0.4615`
- numeric evidence rate: `0.6154`
- answer-label-only rate: `0.3846`
...
| `citylearn` | 2 | 0.0000 | 0.0000 | 1.0000 |
...
`{'answer_label_only': 5, 'no_numeric_evidence': 5, 'too_short': 7}`
